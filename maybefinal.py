...
phonological_processes = {
    'backing': 'atypical', 'fronting': 36, 'gliding': 60, 'stopping': 48, 'vowelisation': 48, 'affrication': 48, 'deaffrication': 48,
    ...
    'cluster reduction': 60, 'final consonant deletion': 48, 'initial consonant deletion': 'atypical',
